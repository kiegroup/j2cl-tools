...
import org.kie.j2cl.tools.yaml.tests.swf.definition.Error;
import org.kie.j2cl.tools.yaml.tests.swf.definition.Error_YamlDeserializerImpl;
import org.kie.j2cl.tools.yaml.tests.swf.definition.Error_YamlSerializerImpl;
...
public class ErrorYamlSerializer implements YAMLDeserializer, YAMLSerializer {
  ...
  public Object deserialize(YamlNode node, YAMLDeserializationContext ctx) {
    ...
    if (node.type() == NodeType.SCALAR) {
      ...
      return ArrayYAMLDeserializer.newInstance(deserializer, Error[]::new).deserialize(node, ctx);
    }
  }
  ...
  public void serialize(
    ...
    if (obj instanceof String) {
      ...
      new ArrayYAMLSerializer<>(serializer).serialize(writer, propertyName, (Error[]) obj, ctx);
    }
  }
