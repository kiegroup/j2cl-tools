...
public class AfterBurnFactoryStepTask implements Task {
  ...
  public AfterBurnFactoryStepTask(IOCContext iocContext, TreeLogger logger) {
  ...
  public void execute() throws UnableToCompleteException {
    ...
    String fileName = "org.kie.j2cl.tools.di.core.internal.AfterBurnFactoryStepTaskMarker";
    try {
