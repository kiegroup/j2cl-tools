...
public class BeanManagerGeneratorTask implements Task {
  ...
  private class BeanManagerGeneratorBuilder {
    ...
    private void initClass() {
      ...
      clazz.addImport("org.kie.j2cl.tools.di.core.internal.QualifierUtil.DEFAULT_ANNOTATION", true, false);
      clazz.addImport("org.kie.j2cl.tools.di.core.internal.QualifierUtil.SPECIALIZES_ANNOTATION", true,
          false);
      clazz.addImport("org.kie.j2cl.tools.di.core.internal.SyncBeanDefImpl.Builder", true, false);
    ...
    private void addEventManager(MethodDeclaration init) {
      String statement =
          "register(new Builder(org.kie.j2cl.tools.di.core.internal.event.EventManager.class, jakarta.inject.Singleton.class)"
              + ".withAssignableTypes(new Class[] { org.kie.j2cl.tools.di.core.internal.event.EventManager.class, org.kie.j2cl.tools.di.core.internal.AbstractEventFactory.class })"
              + ".withFactory(new org.kie.j2cl.tools.di.core.internal.event.EventManager.EventManagerFactory(this)).build());";
