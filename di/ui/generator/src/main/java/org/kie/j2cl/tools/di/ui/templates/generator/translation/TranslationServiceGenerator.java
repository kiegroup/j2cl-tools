...
public class TranslationServiceGenerator {
  ...
  private final static String TRANSLATION_SERVICE = TranslationService.class.getCanonicalName();
  ...
  private void addGetI18nValue(ClassMetaInfo builder) {
    String translationService =
        "private " + TranslationService.class.getCanonicalName() + " translationService = new "
            + TranslationService.class.getCanonicalName() + "Impl.INSTANCE;";
