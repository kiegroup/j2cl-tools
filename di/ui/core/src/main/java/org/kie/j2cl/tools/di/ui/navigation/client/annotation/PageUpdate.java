...
/**
 * Indicates that the target method should be called when the {@link Page} state has been updated
 * from {@link Navigation#updateState(Multimap)}. This will not be invoked when a full page
 * navigation cycle is invoked. Instead {@link PageShown} is more appropriate for full navigation
 * requests.
 * <p>
