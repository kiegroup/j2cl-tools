...
import org.kie.j2cl.tools.di.ui.navigation.client.annotation.PageState;

/**
 * A factory for creating {@link TransitionAnchor} instances. This is useful when, for example,
 * showing a list of items that each are hyperlinked to the same {@link Page} but with different
 * {@link PageState}.
 *
...
public final class TransitionAnchorFactory<P> {
  ...
  /**
   * Gets an instance of a {@link TransitionAnchor} without any additional {@link PageState}.
   */
   ...
   * {@link PageState}. This is a convenience for the use-case where the target {@link Page} has a
   * single piece of state, such as a UUID.
   *
   * @param stateKey
   * @param stateValue
   */
