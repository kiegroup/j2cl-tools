...
/**
 * Factory for Definition domain objects. The <code>identifier</code> argument for
 * <code>accepts</code> and <code>build</code> methods corresponds with the definition type
 * identifier. ( Eg: Task, Rectangle ).
 */
