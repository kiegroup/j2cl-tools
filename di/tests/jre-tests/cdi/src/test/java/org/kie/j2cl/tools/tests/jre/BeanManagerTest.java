...
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.ComponentIface;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.ComponentQualifierOne;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.ComponentQualifierTwo;
import org.kie.j2cl.tools.tests.jre.injection.named.NamedBean;
import org.kie.j2cl.tools.tests.jre.injection.named.NamedBeanSubThree;
...
public class BeanManagerTest extends AbstractTest {
  ...
  public void testNamed() {
    ...
    assertEquals("org.kie.j2cl.tools.tests.jre.injection.named.NamedBeanDefault", componentDefault.say());
    assertEquals("org.kie.j2cl.tools.tests.jre.injection.named.NamedBeanOne", componentOne.say());
    assertEquals("org.kie.j2cl.tools.tests.jre.injection.named.NamedBeanTwo", componentTwo.say());
    ...
    assertEquals("org.kie.j2cl.tools.tests.jre.injection.named.NamedBeanDefault", _defInstance.say());
    ...
    assertEquals("org.kie.j2cl.tools.tests.jre.injection.named.NamedBeanOne", _componentQualifierOne.say());
    ...
    assertEquals("org.kie.j2cl.tools.tests.jre.injection.named.NamedBeanTwo", _componentQualifierTwo.say());
