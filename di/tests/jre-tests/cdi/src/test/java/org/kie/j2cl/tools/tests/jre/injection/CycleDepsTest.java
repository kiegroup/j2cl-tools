...
import org.kie.j2cl.tools.tests.jre.injection.cycle.AbstractRegistryFactory;
import org.kie.j2cl.tools.tests.jre.injection.cycle.AdapterManager;
import org.kie.j2cl.tools.tests.jre.injection.cycle.simple.SimpleBeanOne;
import org.kie.j2cl.tools.tests.jre.injection.cycle.simple.SimpleBeanOneImpl;
import org.kie.j2cl.tools.tests.jre.injection.cycle.simple.SimpleBeanTwo;
import org.kie.j2cl.tools.tests.jre.injection.cycle.simple.SimpleBeanTwoImpl;
...
public class CycleDepsTest extends AbstractTest {
  ...
  public void testSimple() {
    ...
    assertEquals(
        "org.kie.j2cl.tools.tests.jre.injection.cycle.simple.SimpleBeanOneImpl_Factory.ProxySimpleBeanOneImpl",
    ...
    assertEquals(
        "org.kie.j2cl.tools.tests.jre.injection.cycle.simple.SimpleBeanTwoImpl_Factory.ProxySimpleBeanTwoImpl",
  ...
  public void test() {
    ...
    assertEquals(
        "org.kie.j2cl.tools.tests.jre.injection.cycle.ClientRegistryFactoryImpl_Factory.ProxyClientRegistryFactoryImpl",
        abstractRegistryFactory.getClass().getCanonicalName());

    assertEquals(
        "org.kie.j2cl.tools.tests.jre.injection.cycle.AdapterManagerImpl_Factory.ProxyAdapterManagerImpl",
