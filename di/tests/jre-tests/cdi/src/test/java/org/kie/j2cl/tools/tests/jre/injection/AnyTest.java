...
import org.kie.j2cl.tools.tests.jre.injection.any.AnyTestHolder;
import org.kie.j2cl.tools.tests.jre.injection.any.YetAnotherInterface;
...
public class AnyTest extends AbstractTest {
    ...
    public void testAnyYetAnotherBeanManagedInstance() {
        ...
        assertTrue(yetAnotherBean.contains(org.kie.j2cl.tools.tests.jre.injection.any.YetAnotherBeanProducer.class.getSimpleName()));
        assertTrue(yetAnotherBean.contains(org.kie.j2cl.tools.tests.jre.injection.any.YetAnotherBeanOne.class.getSimpleName()));
        assertTrue(yetAnotherBean.contains(org.kie.j2cl.tools.tests.jre.injection.any.YetAnotherBeanTwo.class.getSimpleName()));
