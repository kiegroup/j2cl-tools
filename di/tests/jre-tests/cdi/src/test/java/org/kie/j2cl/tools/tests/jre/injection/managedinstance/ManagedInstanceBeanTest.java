...
import org.kie.j2cl.tools.di.core.internal.IOCResolutionException;
...
import org.kie.j2cl.tools.tests.jre.injection.inheritance.BeanChild;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.any.DefaultPreferencesRegistry;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.any.StunnerPreferencesRegistryLoader;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.generics.GenericTypedBeanHolder;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.inheritance.Child;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.ManagedInstanceBeanHolder;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.SimpleInterface;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.typed.AbstractTypedBeanHolder;
import org.kie.j2cl.tools.tests.jre.injection.managedinstance.typed.SimpleBeanAbstractTyped;
import org.kie.j2cl.tools.tests.jre.injection.qualifiers.controls.LienzoCanvasCommandFactory;
...
public class ManagedInstanceBeanTest extends AbstractTest {
  ...
  public void checkIOCResolutionException() {
    IOCResolutionException exception = assertThrows(IOCResolutionException.class, () -> {
      app.beanManager.lookupBean(SimpleBean.class,
          new org.kie.j2cl.tools.tests.jre.injection.managedinstance.ComponentQualifierTwo() {

            @Override
            public Class<? extends Annotation> annotationType() {
              return org.kie.j2cl.tools.tests.jre.injection.managedinstance.ComponentQualifierTwo.class;
            }
          }).getInstance();
    });
    assertEquals(
        "No beans matched org.kie.j2cl.tools.tests.jre.injection.managedinstance.SimpleBean with qualifiers { org.kie.j2cl.tools.tests.jre.injection.managedinstance.ComponentQualifierTwo }",
  ...
  public void testSelect() {
    ...
    assertEquals(org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.SimpleBean.class,
        app.beanManager.lookupBean(SimpleInterface.class,
            new org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.ComponentQualifierOne() {

              @Override
              public Class<? extends Annotation> annotationType() {
                return org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.ComponentQualifierOne.class;
              }
            }).getInstance().getClass());

    assertFalse(instance
        .select(new org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.ComponentQualifierOne() {
    ...
    assertEquals(org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.SimpleBeanTwo.class,
        app.beanManager.lookupBean(SimpleInterface.class,
            new org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.ComponentQualifierTwo() {

              @Override
              public Class<? extends Annotation> annotationType() {
                return org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.ComponentQualifierTwo.class;
              }
            }).getInstance().getClass());

    assertFalse(instance
        .select(new org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.ComponentQualifierTwo() {
    ...
    assertFalse(instance.select(org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.SimpleBeanTwo.class,
        new org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.ComponentQualifierTwo() {
    ...
    assertEquals(org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.SimpleBeanTwo.class,
        app.beanManager
            .lookupBean(org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.SimpleBeanTwo.class,
                new Default() {
    ...
    assertFalse(instance
        .select(org.kie.j2cl.tools.tests.jre.injection.managedinstance.select.SimpleBeanTwo.class, new Default() {
