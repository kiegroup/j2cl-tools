 ...
 * @version $Id: $
 */
public final class TreeMapXMLDeserializer<K, V>
    extends BaseMapXMLDeserializer<TreeMap<K, V>, K, V> {
   ...
   */
  public static <K, V> TreeMapXMLDeserializer<K, V> newInstance(
   ...
   * @param valueDeserializer {@link XMLDeserializer} used to deserialize the values.
   */
  private TreeMapXMLDeserializer(
      Function<String, XMLDeserializer<K>> keyDeserializer,
      Function<String, XMLDeserializer<V>> valueDeserializer) {
