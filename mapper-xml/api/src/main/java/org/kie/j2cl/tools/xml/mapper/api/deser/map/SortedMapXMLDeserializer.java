...
/**
 * Default {@link XMLDeserializer} implementation for {@link java.util.SortedMap}. The
 ...
 * @version $Id: $
 */
public final class SortedMapXMLDeserializer<K, V>
    extends BaseMapXMLDeserializer<SortedMap<K, V>, K, V> {
   ...
   */
  public static <K, V> SortedMapXMLDeserializer<K, V> newInstance(
   ...
   * @param valueDeserializer {@link XMLDeserializer} used to deserialize the values.
   */
  private SortedMapXMLDeserializer(
      Function<String, XMLDeserializer<K>> keyDeserializer,
      Function<String, XMLDeserializer<V>> valueDeserializer) {
