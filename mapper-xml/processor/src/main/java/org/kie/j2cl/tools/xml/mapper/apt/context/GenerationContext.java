 ...
 */
package org.kie.j2cl.tools.xml.mapper.apt.context;
...
import org.kie.j2cl.tools.xml.mapper.apt.TypeRegistry;
...
public class GenerationContext {
  ...
  public GenerationContext(RoundEnvironment roundEnvironment, ProcessingEnvironment processingEnv) {
    ...
    new CustomHandlerProcessor(this)
        .process(roundEnvironment.getElementsAnnotatedWith(XmlTypeAdapter.class));
